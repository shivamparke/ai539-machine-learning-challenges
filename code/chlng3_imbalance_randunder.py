...
'''
This file performs random undersampling to solve the class imbalance challenge 3.
'''


def get_random_undersampling_results():
    ...
    X_new = X_balanced
    y_new = y_balanced
    # num_oversampled_rows = len(X) - len(under_sampler.sample_indices_)
