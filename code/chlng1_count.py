...
'''
This file implements the count encoding for challenge 1 which is to encode categorical data.
'''


def get_count_encoding_results():
    print('Performing count encoding...')
    print()
